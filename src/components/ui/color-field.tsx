    ...
    <View style={styles.field}>
      ...
      <View style={styles.swatches}>
        {STAMP_COLOR_KEYS.map((key) => {
          ...
          return (
            <Pressable
              ...
              accessibilityLabel={`${label}: ${STAMP_COLOR_LABELS[key]}`}
        ...
        <Pressable
          ...
          accessibilityLabel={`${label}: escolher outra cor`}
        ...
        <View style={styles.sheet} accessibilityViewIsModal>
          ...
          <View style={styles.actions}>
            <Pressable
              ...
              <Text style={typography.value}>Cancelar</Text>
            </Pressable>
            <Pressable
              accessibilityRole="button"
              onPress={() => {
              ...
              <Text style={[typography.value, styles.actionPrimaryLabel]}>Usar esta cor</Text>
            </Pressable>
          </View>
        </View>
      </View>
